...
This is not ready for official release but it works perfectly and saves a lot of time if you know how to use it. It is optimize for Nvidia graphics cards and the scrict gonna check if an Nvidia gpu is detected and gonna offer you to install a recent proprietary driver.
# 1- Download mini.iso
